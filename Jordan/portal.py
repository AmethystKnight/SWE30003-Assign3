...
class MainPortal(ITokenGuide, Portal):
    ...
    def login(self):
        ...
        if self._portal.login():
            ...
            self._portal = self._token.data[TKeys.PortalKey](self)
            print(self._portal)
...
class FOHPortal(Portal):
    def __init__(self, portal):
        """Main portals token functions"""
        self.main_portal = portal
        self._context = None
    ...
    def set_context_menu(self):
        ...
        self._context = Menu()
        self.main_portal.guide_token(facade_menu_db)
        self._context.load_menu(self.main_portal)
...
class Menu(Portal):
    ...
    def __init__(self):
        ...
        self.menu = None
        self._ui = menu_ui_container(self)

    def load_menu(self, source):
        ...
        from facades import Facade_Menu_DB
        menu_db: Facade_Menu_DB = Facade_Menu_DB()
    ...
    def get_ui(self) -> 'menu_ui_container':
        return self._ui
